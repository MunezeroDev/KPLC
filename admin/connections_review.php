...
// $query_conn = "SELECT * FROM connections ORDER BY connection_id WHERE ";
$query_conn = "SELECT * FROM connections WHERE application_progress = 'Under Review' ORDER BY connection_id";
            ...
            <section class="main-section-wrapper">
                ...
                <div class="members">
                    <div class="members-tabs">
                        ...
                        <a href="connections_review.php" class="members-tab active">Connections Under Review</a>
                    </div>
                </div>
